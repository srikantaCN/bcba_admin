        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <div className="mb-10">
              ...
              <select
                className={`relative z-20 w-full appearance-none rounded border border-stroke  px-12 py-2 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input ${
              ...
              >
                ...
                {clients?.map((client) => {
                  return (
                    <option key={client?.ClientId}>{client?.ClientName}</option>
                  );
                })}
              </select>
            </div>
            ...
            {/* <!-- Menu Item Client Info --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/clientInfo" || pathname.includes("clientInfo")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/clientInfo/personal"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/clientInfo/personal" &&
                                "text-white"
                              }`}
                            >
                              Personal
                          ...
                          <li>
                            <Link
                              href="/clientInfo/school"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/clientInfo/school" &&
                                "text-white"
                              } `}
                            >
                              School
                          ...
                          <li>
                            <Link
                              href="/clientInfo/medical"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/clientInfo/medical" &&
                                "text-white"
                              }`}
                            >
                              Medical
                          ...
                          <li>
                            <Link
                              href="/clientInfo/documents"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white  ${
                                pathname === "/clientInfo/documents" &&
                                "text-white"
                              }`}
                            >
                              Documents
            ...
            {/* <!-- Menu Item Behavior start --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/behavior" || pathname.includes("behavior")
                }
              >
                {(handleClick, open) => {
                  return (
            ...
            {/* <!-- Menu Item Behavior end --> */}

            {/* <!-- Menu Item Skills start --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/skills" || pathname.includes("skills")
                }
              >
                {(handleClick, open) => {
                  return (
            ...
            {/* <!-- Menu Item Skills end --> */}

            {/* <!-- Menu Item Caregiver start --> */}
              <li>
                <Link
                  href="/caregiver"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("caregiver") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            {/* <!-- Menu Item Caregiver end --> */}

            {/* <!-- Menu Item Miscellaneous start --> */}
               <SidebarLinkGroup
                activeCondition={
                  pathname === "/miscellaneous" || pathname.includes("miscellaneous")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/miscellaneous" ||
                            pathname.includes("miscellaneous")) &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/miscellaneous/crisisplan"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/miscellaneous/crisisplan" &&
                                "text-white"
                              }`}
                            >
                              Crisis Plan
                          ...
                          <li>
                            <Link
                              href="/miscellaneous/dischargeplan"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/miscellaneous/dischargeplan" &&
                                "text-white"
                              } `}
                            >
                              Discharge Plan
                          ...
                          <li>
                            <Link
                              href="/miscellaneous/generalization-and-maintanence"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/miscellaneous/generalization-and-maintanence" &&
                                "text-white"
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              href="/miscellaneous/transition-and-fading"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white  ${
                                pathname === "/miscellaneous/transition-and-fading" &&
                                "text-white"
                              }`}
                            >
                              Transition & Fading
            ...
            {/* <!-- Menu Item Miscellaneous end --> */}

             {/* <!-- Menu Item Analytics start --> */}
              <li>
                <Link
                  href="/analytics"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("analytics") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
            ...
            {/* <!-- Menu Item Analytics end --> */}

            {/* <!-- Menu Item Communication start --> */}
               <SidebarLinkGroup
                activeCondition={
                  pathname === "/communication" || pathname.includes("communication")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/communication/team"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/communication/team" &&
                                "text-white"
                              }`}
                            >
                              Team
